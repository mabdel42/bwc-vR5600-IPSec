...
class espSetHashAlgorithm(Action):
    def run(self, deviceIP, login, password, cmd_path, espGroup, proposal, hashAlg):
        ...
        url = url_base + "/set/security/vpn/ipsec/esp-group/" + espGroup +  "/proposal/" + proposal + "/hash/" + hashAlg
