...
class ikeSpecifyVersion(Action):
    def run(self, deviceIP, login, password, cmd_path, ikeGroup, ikeVersion):
        ...
        url = url_base + "/set/security/vpn/ipsec/ike-group/" + ikeGroup + "/ike-version/" + ikeVersion
