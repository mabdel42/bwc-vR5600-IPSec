...
class espSetLifetime(Action):
    def run(self, deviceIP, login, password, cmd_path, espGroup, lifetime):
        ...
        url = url_base + "/set/security/vpn/ipsec/esp-group/" + espGroup + "/lifetime/" + lifetime
