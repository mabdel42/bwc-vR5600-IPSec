...
class ikeSetLifetime(Action):
    def run(self, deviceIP, login, password, cmd_path, ikeGroup, lifetime):
        ...
        url = url_base + "/set/security/vpn/ipsec/ike-group/" + ikeGroup + "/lifetime/" + lifetime
