...
class createNodeProposal(Action):
    def run(self, deviceIP, login, password, cmd_path, ikeGroup, proposal):
        ...
        url = url_base + "/set/security/vpn/ipsec/ike-group/" + ikeGroup + "/proposal/" + proposal
