...
class ikeSetEncryptionCipher(Action):
    def run(self, deviceIP, login, password, cmd_path, ikeGroup, proposal, encryption):
        ...
        url = url_base + "/set/security/vpn/ipsec/ike-group/" + ikeGroup + "/proposal/" + proposal + "/encryption/" + encryption
