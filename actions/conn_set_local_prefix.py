...
class connSetLocalPrefix(Action):
    def run(self, deviceIP, login, password, cmd_path, peerIP, tunnelID, localPrefix):
        ...
        url = url_base + url_sup + "/tunnel/" + tunnelID + "/local/prefix/" + localPrefix
